...
def format_and_merge_data(df1):
	...
	merged = merge3.drop(columns=['Age_y', 'Height_y', 'Jersey Number_y', 'Initial', 'ID', 'Surname', 'Photo',
...
# 	                "Current Market Value", "Market Value at Purchase", "Purchase Fee", "Age", "Height", "Club Country", 
...
# 	    st.write(ct)
# 	    ct+=1
# 	    df2 = pd.DataFrame([[name, games, goals, assists, mpg, minutes, MV, prev_MV, fee, age, 
